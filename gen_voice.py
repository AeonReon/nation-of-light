...
for name, text in lines.items():
    if not (name.startswith("ui-w") or name.startswith("ui-b") or name.startswith("ui-fin") or name.startswith("ui-t") or name.startswith("ui-d") or name == "ui-godoor" or name.startswith("ui-s") or name.startswith("ui-a") or name.startswith("ui-ret") or name.startswith("ui-y") or name.startswith("ui-t-") or name.startswith("ui-r") or name.startswith("ui-read-") or name.startswith("ui-en") or name.startswith("ui-lg") or name.startswith("ui-q-") or name.startswith("ui-vis") or name == "ui-deck"): continue
