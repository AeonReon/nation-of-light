...
for name, text in lines.items():
    if not (name.startswith("ui-w") or name.startswith("ui-b") or name.startswith("ui-fin") or name.startswith("ui-t") or name.startswith("ui-d") or name == "ui-deck"): continue
