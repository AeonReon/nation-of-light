...
const V = 'nol-v73';
const SHELL = ['./', 'index.html', 'style.css?v=72', 'rig.js?v=72', 'scene.js?v=72', 'app.js?v=72', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=72'];
