...
const V = 'nol-v76';
const SHELL = ['./', 'index.html', 'style.css?v=76', 'rig.js?v=76', 'scene.js?v=76', 'app.js?v=76', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=76'];
