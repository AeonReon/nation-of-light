...
const V = 'nol-v37';
const SHELL = ['./', 'index.html', 'style.css?v=37', 'rig.js?v=37', 'scene.js?v=37', 'app.js?v=37', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=37'];
