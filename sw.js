...
const V = 'nol-v15';
const SHELL = ['./', 'index.html', 'style.css?v=15', 'rig.js?v=15', 'scene.js?v=15', 'app.js?v=15', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=15'];
