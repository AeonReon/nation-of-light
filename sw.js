...
const V = 'nol-v42';
const SHELL = ['./', 'index.html', 'style.css?v=42', 'rig.js?v=42', 'scene.js?v=42', 'app.js?v=42', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=42'];
