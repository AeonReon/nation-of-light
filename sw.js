...
const V = 'nol-v63';
const SHELL = ['./', 'index.html', 'style.css?v=63', 'rig.js?v=63', 'scene.js?v=63', 'app.js?v=63', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=63'];
