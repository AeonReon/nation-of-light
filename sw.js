...
const V = 'nol-v53';
const SHELL = ['./', 'index.html', 'style.css?v=53', 'rig.js?v=53', 'scene.js?v=53', 'app.js?v=53', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=53'];
