...
const V = 'nol-v49';
const SHELL = ['./', 'index.html', 'style.css?v=49', 'rig.js?v=49', 'scene.js?v=49', 'app.js?v=49', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=49'];
