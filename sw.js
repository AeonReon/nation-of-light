...
const V = 'nol-v86';
const SHELL = ['./', 'index.html', 'style.css?v=86', 'rig.js?v=86', 'scene.js?v=86', 'app.js?v=86', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=86'];
