...
const V = 'nol-v61';
const SHELL = ['./', 'index.html', 'style.css?v=61', 'rig.js?v=61', 'scene.js?v=61', 'app.js?v=61', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=61'];
