...
const V = 'nol-v44';
const SHELL = ['./', 'index.html', 'style.css?v=44', 'rig.js?v=44', 'scene.js?v=44', 'app.js?v=44', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=44'];
