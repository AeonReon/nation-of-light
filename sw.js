...
const V = 'nol-v16';
const SHELL = ['./', 'index.html', 'style.css?v=16', 'rig.js?v=16', 'scene.js?v=16', 'app.js?v=16', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=16'];
