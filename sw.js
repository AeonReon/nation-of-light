...
const V = 'nol-v88';
const SHELL = ['./', 'index.html', 'style.css?v=88', 'rig.js?v=88', 'scene.js?v=88', 'app.js?v=88', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=88'];
