...
const V = 'nol-v40';
const SHELL = ['./', 'index.html', 'style.css?v=40', 'rig.js?v=40', 'scene.js?v=40', 'app.js?v=40', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=40'];
