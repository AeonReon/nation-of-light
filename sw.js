...
const V = 'nol-v20';
const SHELL = ['./', 'index.html', 'style.css?v=20', 'rig.js?v=20', 'scene.js?v=20', 'app.js?v=20', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=20'];
