...
const V = 'nol-v80';
const SHELL = ['./', 'index.html', 'style.css?v=80', 'rig.js?v=80', 'scene.js?v=80', 'app.js?v=80', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=80'];
