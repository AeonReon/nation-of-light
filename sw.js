...
const V = 'nol-v54';
const SHELL = ['./', 'index.html', 'style.css?v=54', 'rig.js?v=54', 'scene.js?v=54', 'app.js?v=54', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=54'];
