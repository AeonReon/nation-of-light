...
const V = 'nol-v18';
const SHELL = ['./', 'index.html', 'style.css?v=18', 'rig.js?v=18', 'scene.js?v=18', 'app.js?v=18', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=18'];
