...
const V = 'nol-v50';
const SHELL = ['./', 'index.html', 'style.css?v=50', 'rig.js?v=50', 'scene.js?v=50', 'app.js?v=50', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=50'];
