...
const V = 'nol-v19';
const SHELL = ['./', 'index.html', 'style.css?v=19', 'rig.js?v=19', 'scene.js?v=19', 'app.js?v=19', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=19'];
