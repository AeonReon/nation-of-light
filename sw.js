...
const V = 'nol-v17';
const SHELL = ['./', 'index.html', 'style.css?v=17', 'rig.js?v=17', 'scene.js?v=17', 'app.js?v=17', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=17'];
