...
const V = 'nol-v77';
const SHELL = ['./', 'index.html', 'style.css?v=77', 'rig.js?v=77', 'scene.js?v=77', 'app.js?v=77', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=77'];
