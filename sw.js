...
const V = 'nol-v22';
const SHELL = ['./', 'index.html', 'style.css?v=22', 'rig.js?v=22', 'scene.js?v=22', 'app.js?v=22', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=22'];
