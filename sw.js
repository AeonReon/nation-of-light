...
const V = 'nol-v52';
const SHELL = ['./', 'index.html', 'style.css?v=52', 'rig.js?v=52', 'scene.js?v=52', 'app.js?v=52', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=52'];
