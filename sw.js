...
const V = 'nol-v82';
const SHELL = ['./', 'index.html', 'style.css?v=82', 'rig.js?v=82', 'scene.js?v=82', 'app.js?v=82', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=82'];
