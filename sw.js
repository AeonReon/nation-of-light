...
const V = 'nol-v74';
const SHELL = ['./', 'index.html', 'style.css?v=74', 'rig.js?v=74', 'scene.js?v=74', 'app.js?v=74', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=74'];
