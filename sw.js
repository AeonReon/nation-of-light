...
const V = 'nol-v79';
const SHELL = ['./', 'index.html', 'style.css?v=79', 'rig.js?v=79', 'scene.js?v=79', 'app.js?v=79', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=79'];
