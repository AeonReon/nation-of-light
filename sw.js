...
const V = 'nol-v59';
const SHELL = ['./', 'index.html', 'style.css?v=59', 'rig.js?v=59', 'scene.js?v=59', 'app.js?v=59', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=59'];
