...
const V = 'nol-v38';
const SHELL = ['./', 'index.html', 'style.css?v=38', 'rig.js?v=38', 'scene.js?v=38', 'app.js?v=38', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=38'];
