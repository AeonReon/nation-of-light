...
const V = 'nol-v75';
const SHELL = ['./', 'index.html', 'style.css?v=75', 'rig.js?v=75', 'scene.js?v=75', 'app.js?v=75', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=75'];
