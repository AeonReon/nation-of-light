...
const V = 'nol-v65';
const SHELL = ['./', 'index.html', 'style.css?v=65', 'rig.js?v=65', 'scene.js?v=65', 'app.js?v=65', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=65'];
