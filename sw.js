...
const V = 'nol-v39';
const SHELL = ['./', 'index.html', 'style.css?v=39', 'rig.js?v=39', 'scene.js?v=39', 'app.js?v=39', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=39'];
