...
const V = 'nol-v46';
const SHELL = ['./', 'index.html', 'style.css?v=46', 'rig.js?v=46', 'scene.js?v=46', 'app.js?v=46', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=46'];
