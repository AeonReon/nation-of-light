...
const V = 'nol-v81';
const SHELL = ['./', 'index.html', 'style.css?v=81', 'rig.js?v=81', 'scene.js?v=81', 'app.js?v=81', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=81'];
