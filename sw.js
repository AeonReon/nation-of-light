...
const V = 'nol-v71';
const SHELL = ['./', 'index.html', 'style.css?v=71', 'rig.js?v=71', 'scene.js?v=71', 'app.js?v=71', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=71'];
