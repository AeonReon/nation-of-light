...
const V = 'nol-v33';
const SHELL = ['./', 'index.html', 'style.css?v=33', 'rig.js?v=33', 'scene.js?v=33', 'app.js?v=33', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=33'];
