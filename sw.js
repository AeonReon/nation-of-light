...
const V = 'nol-v29';
const SHELL = ['./', 'index.html', 'style.css?v=29', 'rig.js?v=29', 'scene.js?v=29', 'app.js?v=29', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=29'];
