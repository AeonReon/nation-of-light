...
const V = 'nol-v27';
const SHELL = ['./', 'index.html', 'style.css?v=27', 'rig.js?v=27', 'scene.js?v=27', 'app.js?v=27', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=27'];
