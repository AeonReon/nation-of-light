...
const V = 'nol-v70';
const SHELL = ['./', 'index.html', 'style.css?v=70', 'rig.js?v=70', 'scene.js?v=70', 'app.js?v=70', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=70'];
