...
const V = 'nol-v60';
const SHELL = ['./', 'index.html', 'style.css?v=60', 'rig.js?v=60', 'scene.js?v=60', 'app.js?v=60', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=60'];
