...
const V = 'nol-v89';
const SHELL = ['./', 'index.html', 'style.css?v=89', 'rig.js?v=89', 'scene.js?v=89', 'app.js?v=89', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=89'];
