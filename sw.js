...
const V = 'nol-v68';
const SHELL = ['./', 'index.html', 'style.css?v=68', 'rig.js?v=68', 'scene.js?v=68', 'app.js?v=68', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=68'];
