...
const V = 'nol-v51';
const SHELL = ['./', 'index.html', 'style.css?v=51', 'rig.js?v=51', 'scene.js?v=51', 'app.js?v=51', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=51'];
