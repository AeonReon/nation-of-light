...
const V = 'nol-v31';
const SHELL = ['./', 'index.html', 'style.css?v=31', 'rig.js?v=31', 'scene.js?v=31', 'app.js?v=31', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=31'];
