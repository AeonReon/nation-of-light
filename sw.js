...
const V = 'nol-v64';
const SHELL = ['./', 'index.html', 'style.css?v=64', 'rig.js?v=64', 'scene.js?v=64', 'app.js?v=64', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=64'];
