...
const V = 'nol-v87';
const SHELL = ['./', 'index.html', 'style.css?v=87', 'rig.js?v=87', 'scene.js?v=87', 'app.js?v=87', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=87'];
