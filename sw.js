...
const V = 'nol-v26';
const SHELL = ['./', 'index.html', 'style.css?v=26', 'rig.js?v=26', 'scene.js?v=26', 'app.js?v=26', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=26'];
