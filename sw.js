...
const V = 'nol-v58';
const SHELL = ['./', 'index.html', 'style.css?v=58', 'rig.js?v=58', 'scene.js?v=58', 'app.js?v=58', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=58'];
