...
const V = 'nol-v62';
const SHELL = ['./', 'index.html', 'style.css?v=62', 'rig.js?v=62', 'scene.js?v=62', 'app.js?v=62', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=62'];
