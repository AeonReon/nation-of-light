...
const V = 'nol-v66';
const SHELL = ['./', 'index.html', 'style.css?v=66', 'rig.js?v=66', 'scene.js?v=66', 'app.js?v=66', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=66'];
