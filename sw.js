...
const V = 'nol-v48';
const SHELL = ['./', 'index.html', 'style.css?v=48', 'rig.js?v=48', 'scene.js?v=48', 'app.js?v=48', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=48'];
