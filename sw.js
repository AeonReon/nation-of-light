...
const V = 'nol-v41';
const SHELL = ['./', 'index.html', 'style.css?v=41', 'rig.js?v=41', 'scene.js?v=41', 'app.js?v=41', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=41'];
