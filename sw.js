...
const V = 'nol-v30';
const SHELL = ['./', 'index.html', 'style.css?v=30', 'rig.js?v=30', 'scene.js?v=30', 'app.js?v=30', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=30'];
