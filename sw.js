...
const V = 'nol-v84';
const SHELL = ['./', 'index.html', 'style.css?v=84', 'rig.js?v=84', 'scene.js?v=84', 'app.js?v=84', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=84'];
