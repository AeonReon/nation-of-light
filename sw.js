...
const V = 'nol-v23';
const SHELL = ['./', 'index.html', 'style.css?v=23', 'rig.js?v=23', 'scene.js?v=23', 'app.js?v=23', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=23'];
