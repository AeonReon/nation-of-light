...
const V = 'nol-v78';
const SHELL = ['./', 'index.html', 'style.css?v=78', 'rig.js?v=78', 'scene.js?v=78', 'app.js?v=78', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=78'];
