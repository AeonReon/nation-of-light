...
const V = 'nol-v32';
const SHELL = ['./', 'index.html', 'style.css?v=32', 'rig.js?v=32', 'scene.js?v=32', 'app.js?v=32', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=32'];
