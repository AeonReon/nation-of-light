...
const V = 'nol-v83';
const SHELL = ['./', 'index.html', 'style.css?v=83', 'rig.js?v=83', 'scene.js?v=83', 'app.js?v=83', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=83'];
