...
const V = 'nol-v69';
const SHELL = ['./', 'index.html', 'style.css?v=69', 'rig.js?v=69', 'scene.js?v=69', 'app.js?v=69', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=69'];
