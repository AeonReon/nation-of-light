...
const V = 'nol-v21';
const SHELL = ['./', 'index.html', 'style.css?v=21', 'rig.js?v=21', 'scene.js?v=21', 'app.js?v=21', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=21'];
