...
const V = 'nol-v28';
const SHELL = ['./', 'index.html', 'style.css?v=28', 'rig.js?v=28', 'scene.js?v=28', 'app.js?v=28', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=28'];
