...
const V = 'nol-v85';
const SHELL = ['./', 'index.html', 'style.css?v=85', 'rig.js?v=85', 'scene.js?v=85', 'app.js?v=85', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=85'];
