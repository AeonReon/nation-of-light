...
const V = 'nol-v14';
const SHELL = ['./', 'index.html', 'style.css?v=14', 'rig.js?v=14', 'scene.js?v=14', 'app.js?v=14', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=14'];
