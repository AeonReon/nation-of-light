...
const V = 'nol-v47';
const SHELL = ['./', 'index.html', 'style.css?v=47', 'rig.js?v=47', 'scene.js?v=47', 'app.js?v=47', 'content.json', 'school.json', 'audio/marcus/visemes.json', 'manifest.webmanifest?v=47'];
